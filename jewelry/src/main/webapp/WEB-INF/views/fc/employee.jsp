            ...
            <div class="col-md-6 col-md-6 col-sm-6 col-xs-12">
                ...
                <div class="hpanel">
                    <div class="panel-body">
                        <form action="/jewelry/fc/employee.action" method="post" id="loginForm">
                            <div class="row">
                            	<input type="hidden" name="userNo" value="${user.userNo}">
                                <div class="form-group col-lg-12">
                                    <label>아이디</label>
                                    <input id="emId" name="userId" class="form-control">
                                </div>
                                <div class="form-group col-lg-6">
                                    <label>패스워드</label>
                                    <input id="emPswd" name="userPswd" type="password" class="form-control">
                                </div>
                             <!--    <div class="form-group col-lg-6">
                                    <label>패스워드 확인</label>
                                ...
                                <div class="form-group col-lg-6">
                                    <label>이름</label>
                                    <input id="emName" name="userName" class="form-control">
                                </div>
                                <div class="form-group col-lg-6">
                                    <label>전화번호</label>
                                    <input id="emPhone" name="userPhone" class="form-control">
                                </div>
                                <div class="form-group col-lg-6">
                                    <label>이메일</label>
                                    <input id="emEmail" name="userEmail" class="form-control">
                                </div>
							...
							<a href="/jewelry/fc/empmanagement.action" class="btn btn-default btn-block">Cancel</a>
						</div>
                        </form>
